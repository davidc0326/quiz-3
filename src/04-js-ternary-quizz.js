...
const stringVarIsHello = stringVar === "Hello";
const numberVarIsNot6 = numberVar !== 6;
const bothConditionsMet = stringVarIsHello && numberVarIsNot6;
console.log("[Question #20]: ", bothConditionsMet); // should print true
...
const typeOfStr = typeof stringVar === "string";
console.log("[Question #25]: ", typeOfStr); // should print true

// 26. Compare the values of 'numberVar' and the string '5' using the loose equality operator.
const looseEquality = numberVar == "5";
console.log("[Question #26]: ", looseEquality); // should print true
...
const moreThan3Elements = fruits.length > 3;
console.log("[Question #36]: ", moreThan3Elements); // should print true if it does, false if it does not
...
console.log("[Question #41]: ", isBothConditionsMet); // should print false
...
console.log("[Question #44]: ", isBetween4And6); // should print true
...
console.log("[Question #69]: ", isParisOrBraveNewWorld); // should print true
...
console.log("[Question #72]: ", isCityString); // should print true
...
console.log("[Question #80]: ", hasExactly2Elements);
...
const doesNotIncludeJupiter = !planets.includes("Jupiter");
console.log("[Question #82]: ", doesNotIncludeJupiter);

// 83. Check if 'radius' is between 5 and 10 using logical operators.
const isRadiusBetween5And10 = radius > 5 && radius < 10;
console.log("[Question #83]: ", isRadiusBetween5And10);
...
const isDaysArrayNotEmpty = days.length > 0;
console.log("[Question #88]: ", isDaysArrayNotEmpty);
...
const weightEqualWeightStr = weight == weightStr;
console.log("[Question #96]: ", weightEqualWeightStr);
